...
mdRenderer.heading = function(text, level) {
  ...
  return format('<h{0} class="docs-header"><a name="{1}" class="docs-header-icon" href="#{1}"></a>{2}</h{0}>', [level, escapedText, text]);
}
mdRenderer.code = function(code, language) {
  ...
  var output = format('<div class="docs-code" data-docs-code><pre><code class="lang-{0}">{1}</code></pre></div>', [language, renderedCode]);
...
module.exports = function(files, callback) {
  ...
  for (var file in files) {
    fileTasks.push(function(cb) {
      ...
      page.docs = marked(pageData.body, {renderer: mdRenderer});
